...
#cd ~/Documents
cd /home/aubcls61/Group_CID_7180_final_project/Phylogenetic_Tree
...
efetch -format fasta >> /home/aubcls61/Group_CID_7180_final_project/Phylogenetic_Tree
/"$specname1".fasta
...
while [ -z "$REPLY" ] ; do 
	...
	case $REPLY in
		[Yy]es) #if Yes, repeat DNA search for newly entered species
			...
			efetch -format fasta >> /home/aubcls61/Group_CID_7180_final_project/Phylogenetic_Tree "$specname2".fasta
			unset REPLY ;;
...
rename -f 's/ /_/g' ~/Group_CID_7180_final_project/Phylogenetic_Tree/*.fasta

#Combine all species DNA into one file
cat ~/Group_CID_7180_final_project/Phylogenetic_Tree/*.fasta > ~/Group_CID_7180_final_project/Phylogenetic_Tree/allseq.fasta
...
grep -c ">" ~/Group_CID_7180_final_project/Phylogenetic_Tree/*.fasta
